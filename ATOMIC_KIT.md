...
> Atomic brand kit for Lore. Built on the "HTML Brand" framework (Emmett / Little Plains, 2026). One brand encoded in two formats:
...
└── agent/
    ├── verbal/            ← brand-wide voice, positioning, audience
    │   ├── positioning.md
    │   ├── audience.yaml
    │   ├── messaging.md
    │   ├── differentiation.md
    ...
    │   ├── tokens/        ← token specimens (introspectable JSON)
