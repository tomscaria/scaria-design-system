...
ROLR ships two surfaces that share one book: `arcade-dark` (Pro · desktop · marketing) and `arcade-light` (Casual · iOS). Same balance, positions and liquidity underneath — the theme is the surface, not a separate account.
