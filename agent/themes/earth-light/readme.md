...
Default for both marketing and product surfaces unless the consuming product overrides. Use `earth-light` in the daytime, brand-canonical Lore presence — pitch decks, partner-facing flows, the marketing site.
...
`earth-dark` is the inversion — same brand identity, dark surface. They share `--accent` value; surfaces, foreground, and lines invert.
