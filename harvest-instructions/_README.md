...
|---|---|---|
| `tomscaria/Thomas-OS` | D3 chart primitives, logo systems, any DS edits ahead of `scaria-design-system` HEAD | `agent/components/d3-charts/`, `agent/visual/assets/logos/`, diff-audit of `agent/components/*` |
...
2. **Diff audit.** Compare source HEAD against `scaria-design-system` HEAD. Identify which files are genuinely ahead vs. drift.
