window['web_common'] = 
{
    ...
    "trade_charts_function_send_backward": "Send backward",
    "ok_component_okline_indicator_name_volume": "VOLUME",
    "commonall_emptystate_text_no_data": "No data available",
    "trade_charts_textarea_text_signal_length": "Signal length",
    ...
    "trade_charts_function_charts_snapshot": "Chart snapshot",
    "a11y_web_pagination_btn_universal_pagenum": "Page {num}",
    "trade_charts_text_switch_time": "Change interval",
    "trade_charts_textarea_text_short_length": "Short length",
    ...
    "trade_charts_textarea_desc_tsi": "This indicator analyzes price momentum to measure trend strength and direction. Values above 0 indicate upward momentum, while those below 0 indicate downward momentum, helping confirm trend direction or identify early reversal signals.",
    ...
    "trade_charts_indicator_setting_ob": "OB",
    ...
    "trade_okline_custom_indicators": "Custom indicators",
    ...
    "trade_charts_indicator_setting_os": "OS",
    ...
    "trade_charts_function_fib_extension": "Fib extension",
    ...
    "trade_charts_indicator_text_sigma": "Sigma length",
    ...
    "trade_charts_indicator_desc_mfi": "This indicator is a momentum-based tool that uses price and volume to measure the strength of money flowing into and out of the market.",
    ...
    "trade_charts_indicator_text_nvi": "NVI",
    ...
    "trade_charts_indicator_text_tsi_true": "True strength index",
    ...
    "trade_charts_textarea_text_middle": "Middle",
    ...
    "trade_settings_option_support_lines": "Support line",
    ...
    "trade_charts_textarea_tsi": "TSI (Trend Strength Index)",
    ...
    "trade_charts_textarea_text_signal": "Signal",
    ...
    "trade_charts_indicator_text_overbought": "Overbought",
    ...
    "trade_charts_indicator_pvt": "PVT (Price Volume Trend)",
    ...
    "trade_charts_textarea_title_rvi": "RVI (Relative Volatility Index)",
    ...
    "trade_okline_not_support_market_cap": "Market cap data is not supported for this symbol.",
    ...
    "trade_settings_info_coachmark_cal_moved": "The Economic calendar settings have moved from Chart settings to the Display menu.",
    ...
    "trade_settings_option_resistance_lines": "Resistance line",
    "trade_charts_textarea_text_middle_length": "Middle length",
    "trade_charts_indicator_fib_trend_line": "Trend line",
    ...
    "okd_rangepicker_errormsg_tips_seconds_limit": "You’re using an interval with seconds, so you can only view data from the past 3 months. Select a different interval to view earlier data.",
    ...
    "trade_charts_textarea_text_long": "Long",
    ...
    "trade_settings_select_chart_indication_resist_and_support": "RESIST (resistance and support lines)",
    ...
    "trade_charts_function_text_paste": "Paste",
    ...
    "trade_charts_qqe_slow": "Slow × 1,000",
    ...
    "trade_charts_title_ema_period": "EMA period",
    ...
    "trade_charts_indicator_desc_tsi_true": "This indicator measures the direction and strength of price momentum by applying double exponential smoothing to both price changes and their absolute values. The TSI line oscillates between -100 and +100. A TSI line crossover above the signal line is a bullish reference, while a crossover below is a bearish reference. Values above 0 indicate bullish momentum, while values below 0 indicate bearish momentum.",
    "trade_charts_textarea_text_short": "Short",
    ...
    "trade_charts_function_text_copy": "Copy",
    ...
    "trade_mid_label_econ_calendar_events": "Economic calendar",
    ...
    "trade_charts_textarea_text_length_1": "Length 1",
    "trade_charts_textarea_label_taker_buysell_vol": "Taker buy/sell volume",
    "commonall_enterfield_title_total": "Total",
    "trade_charts_textarea_text_length_2": "Length 2",
    ...
    "trade_charts_function_image_copied": "Chart image copied",
    ...
    "trade_charts_checkbox_header_wma": "Weighted Moving Average (WMA)",
    ...
    "trade_settings_textarea_desc_resist_and_support": "This advanced tool uses Volume Profile principles to identify high-volume price zones and automatically generates a support and a resistance line. These lines mark areas where the market may stall, reverse, or consolidate, offering data-driven insights into price trends. \n\nSupport line: A price level where buyers tend to prevent further declines. \nResistance line: A price level where sellers tend to cap price rises. \nTicks per row: Specifies how many ticks are displayed in each row. Each tick represents the smallest price movement of the pair.",
    ...
    "trade_charts_title_tsi_line_color": "TSI color",
    ...
    "trade_charts_indicator_text_rci": "RCI ribbon",
    ...
    "trade_charts_text_more_value": "{num, plural, =1 {{num} more value} other {{num} more values}}",
    ...
    "trade_charts_indicator_pvt_setting": "PVT",
    ...
    "okd_upload_title_filesnum": "{numbers} file(s)",
    ...
    "trade_charts_indicator_desc_pmo": "This oscillator applies double smoothing to the ROC (rate of change) in price to measure medium- to long-term momentum. A PMO line crossover above the signal line is a bullish reference, while a crossover below is a bearish reference.",
    ...
    "trade_charts_indicator_time_period": "Time period",
    ...
    "trade_charts_indicator_text_oversold": "Oversold",
    ...
    "trade_charts_indicator_setting_mfi": "MFI",
    ...
    "trade_charts_function_download_image": "Download image",
    ...
    "trade_charts_indicator_title_pvt": "PVT",
    ...
    "trade_charts_function_bring_forward": "Bring forward",
    ...
    "trade_charts_textarea_signal": "Signal",
    "trade_mid_dialog_custom_formula_how_to": "What is custom formula?",
    "trade_charts_order_line_limit_tp": "Limit TP",
    "trade_okline_tooltip_switch_native_chart_to_sync_drawings": "Drawings and indicators on TradingView charts will not sync to the App. Switch to the native chart to enable syncing.",
    ...
    "trade_charts_textarea_length": "Length",
    "trade_charts_function_text_hide": "Hide",
    ...
    "trade_charts_indicator_pvt_desc": "This momentum indicator combines price changes and trading volume to measure money flow and confirm trends. Compared to OBV (On Balance Volume), which only adds or subtracts volume based on the price movement direction, PVT focuses on the magnitude of price changes, providing a more accurate reflection of trend strength.",
    ...
    "trade_charts_function_to_front": "Bring to front",
    ...
    "trade_settings_option_ticks_per_row": "Ticks per row",
    ...
    "trade_charts_indicator_text_pmo_full": "PMO (Price Momentum Oscillator)",
    ...
    "trade_charts_function_visual_order": "Visual order",
    ...
    "trade_charts_textarea_btn_tsi": "TSI",
    "trade_econ_calendar_article_gdp_growth_qoq_final": "GDP Growth Rate QoQ Final (U.S.)",
    "trade_charts_indicator_mfi": "MFI (Money Flow Index)",
    "commonall_resultpage_title_processing": "Processing",
    "trade_charts_indicator_setting_background": "Background",
    ...
    "trade_charts_indicator_desc_rci_ribbon": "This indicator plots 3 RCI oscillators with different lookback periods to show trend consistency across multiple timeframes. Values near +100 suggest a strong uptrend, while those near -100 suggest a strong downtrend.",
    ...
    "trade_charts_function_brush": "Brush",
    "trade_charts_indicator_text_tsi_trend": "Trend strength index",
    ...
    "trade_charts_indicator_desc_nvi": "This trend indicator tracks price changes only when volume decreases, helping identify potential smart money activity. A rising NVI suggests prices are strengthening during low-volume periods, often seen as a sign of quiet accumulation. Use it with a moving average to help identify trend direction.",
    ...
    "trade_charts_indicator_text_short": "Short",
    ...
    "trade_charts_ten_test_b": "no chinese",
    "trade_charts_ten_test_a": "hello",
    ...
    "trade_charts_function_text_unlock": "Unlock",
    "trade_charts_tab_appearance_kline": "Candles",
    "trade_charts_function_text_clone": "Clone",
    "trade_chart_kline_lot": "Lot",
    ...
    "trade_charts_indicator_text_mass_index_full": "Mass Index",
    ...
    "trade_charts_indicator_text_manvi": "MANVI",
    ...
    "trade_charts_indicator_text_nvi_full": "NVI (Negative Volume Index)",
    ...
    "trade_charts_indicator_desc_mass_index": "This volatility indicator measures changes in the range between high and low prices over a set period. A reversal bulge occurs when the range expands and then contracts, signaling that a trend reversal is likely.",
    ...
    "trade_charts_textarea_text_pmo": "PMO",
    "trade_charts_indicator_text_long": "Long",
    "trade_charts_checkbox_volume": "VOLUME",
    "ok_component_okline_indicator_name_kdj": "KDJ",
    "trade_charts_textarea_text_long_length": "Long length",
    ...
    "trade_charts_textarea_bear_color": "Bear color",
    ...
    "trade_charts_function_text_more": "More",
    ...
    "trade_charts_indicator_text_mass_index": "Mass Index",
    ...
    "trade_charts_indicator_text_rci_ribbon_full": "RCI (Rank Correlation Index) Ribbon",
    ...
    "okd_rangepicker_errormsg_tips_range": "Data range limited to 3 months",
    "okd_datepicker_month_november": "November",
    "ok_component_okline_period_more": "Available",
    "trade_charts_textarea_desc_rvi": "This volatility indicator measures the standard deviation of price changes over time to track the direction of price fluctuations. Values above 50 suggest strengthening upward volatility, while those below 50 signal increasing downward pressure.",
