...
// Usage: <body data-theme="earth-light"> + <script src="theme-switcher.js" defer></script>
(function(){
  const THEMES = [
    {id:'earth-light',   label:'Hearth',    dot:'#F2EADB', ring:'#141613'},
    {id:'earth-dark',    label:'Midnight',  dot:'#0E1410', ring:'#D4F24B'},
    {id:'revenant-light',label:'Rev·L',   dot:'#F1EEEB', ring:'#FF4F00'},
    {id:'revenant-dark', label:'Rev·D',   dot:'#0E0F0C', ring:'#FF4F00'},
    {id:'arcade-light',    label:'ROLR·L',  dot:'#FFFBF0', ring:'#6664FC'},
    {id:'arcade-dark',     label:'ROLR·D',  dot:'#0B0B0E', ring:'#6664FC'},
  ...
  const saved = localStorage.getItem(LS_KEY) || body.dataset.theme || 'earth-light';
